...
const renderData = dataInput => {
    ...
    searchNumField.innerHTML = `<p id="searchResult-text">本次搜尋共 ${dataInput.length}筆資料</p>`;
...
const search = region => {
    ...
    searchArea = data.filter(areaData => areaData.area == region);
    renderData(searchArea);
};
